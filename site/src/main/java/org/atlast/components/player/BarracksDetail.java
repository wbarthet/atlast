...
import org.atlast.beans.Barracks;
 ...
 */
public class BarracksDetail extends BaseSecuredComponent {

    private static Logger log = LoggerFactory.getLogger(BarracksDetail.class);
    ...
    public void doBeforeRender(final HstRequest request, final HstResponse response) throws HstComponentException {
        ...
        Barracks barracks = requestContext.getContentBean(Barracks.class);

        Player player = barracks.getPlayer();

        request.setAttribute("barracks", barracks);
        ...
        try {
            ...
            if ("alignment".equals(getPublicRequestParameter(request, "sort"))) {
                ...
                query.addOrderByDescending("skill-warrior");
            }
            query.setLimit(10);
        ...
        try {
            ...
            filter.addEqualTo("atlast:skill", "warrior");
