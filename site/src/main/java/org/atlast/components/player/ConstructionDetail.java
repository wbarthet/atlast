...
import org.atlast.beans.Construction;
 ...
 */
public class ConstructionDetail extends BaseSecuredComponent {

    private static Logger log = LoggerFactory.getLogger(ConstructionDetail.class);
    ...
    public void doBeforeRender(final HstRequest request, final HstResponse response) throws HstComponentException {
        ...
        Construction construction = requestContext.getContentBean(Construction.class);

        Player player = construction.getPlayer();

        request.setAttribute("construction", construction);
        ...
        try {
            ...
            if ("alignment".equals(getPublicRequestParameter(request, "sort"))) {
                ...
                query.addOrderByDescending("skill-builder");
            }
            query.setLimit(10);
        ...
        try {
            ...
            filter.addEqualTo("atlast:skill", "builder");
